...
<html lang="en">
  <head>
    <title>MJNS MOSS</title>
    <meta charset="utf-8">
    <meta name = "format-detection" content = "telephone=no" />
    <meta name="description" content="MJNS-Pi">
    <meta name="author" content="MJNS MOSS">
    ...
    <div class="bg-1 page_home">
		    <section class="main">
			<div id="topmenu"></div>
			<div id="master-cacti" align="center"></div>
			<div id="master-dashboard" align="center"></div>
			<div id="master-thome" align="center"></div>
			<div id="master-connectivity" align="center"></div>
			<div id="master-wol" align="center"></div>
			<div id="master-wol-list" align="center"></div>
			<div id="master-shell" align="center"></div>
			<div id="master-support" align="center"></div>
