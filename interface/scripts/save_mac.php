...
$smaip = $_POST['smaip'];
  ...
  try {
    ...
    **************************************/
    ...
    $file_db->exec("CREATE TABLE IF NOT EXISTS macaddresses (
    ...
    $insert = $file_db->prepare('INSERT INTO macaddresses (smanf, smamf, smaipf) VALUES (?, ?, ?)');
    $insert->execute(array($smad, $smam, $smaip));
